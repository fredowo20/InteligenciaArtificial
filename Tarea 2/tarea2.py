...
def main():
    ...
    with open('datos.csv', 'r') as csvfile:
        ...
        for row in reader:
            ...
            real_x.append(real_state[0])
            real_y.append(real_state[1])
            estimado_x.append(state_estimator.get_state()[0])
            estimado_y.append(state_estimator.get_state()[1])
    ...
    plt.plot(estimado_x, estimado_y)
